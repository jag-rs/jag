...
impl MaskFilterRenderer {
    pub fn new(device: Arc<wgpu::Device>, format: wgpu::TextureFormat) -> Self {
        ...
        let composite_pipeline = crate::gpu_pipeline::create_render_pipeline(
            &device,
            crate::gpu_pipeline::RenderPipelineDescriptor {
    ...
    pub(crate) fn composite_group(
        ...
        next_layer: &wgpu::TextureView,
        operation: crate::MaskComposite,
    ) -> wgpu::BindGroup {
        let mut params = [0u32; 28];
        params[0] = match operation {
            crate::MaskComposite::Add => 0,
            crate::MaskComposite::Subtract => 1,
        ...
        crate::gpu_bindings::create_bind_group(
            ...
            &[
                ...
                wgpu::BindGroupEntry {
                    binding: 1,
                    resource: wgpu::BindingResource::TextureView(next_layer),
                },
                wgpu::BindGroupEntry {
                    binding: 2,
                    resource: wgpu::BindingResource::Sampler(&self.sampler),
    ...
    pub(crate) fn params(
        ...
        MaskParams {
            ...
            extra_flags: [u32::from(coverage_only), 0],
            flags: [
